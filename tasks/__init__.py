...
try:
    from tasks.wind import wind_import_once, wind_weekly_task, wind_daily_task, import_stock_daily
except ImportError:
...
func_list = [
    (wind_import_once, 'wind 导入一次'),
    (import_stock_daily, 'wind 日常任务'),
    (grouped_task_weekly, 'wind 每周导入'),
